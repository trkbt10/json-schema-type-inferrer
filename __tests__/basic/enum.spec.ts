...
describe("Enum", () => {
  ...
  it("InferPrimitiveJSONSchemaType", () => {
    ...
    const enums2: InferJSONSchemaType<Schema, Schema> = 1;
    const schema2 = {
      enum: [
        "array",
        "boolean",
    ...
    const strEnums2: InferJSONSchemaType<Schema2, Schema2> = "string";
  });
  it("nullable enum", () => {
    const schema = {
      enum: [
    ...
    const type2: InferJSONSchemaType<Schema, Schema> = null;
  });
});
